...
cache = Cache(app)
cache.cached(make_cache_key=CacheFunctions.cache_key)
...
@cache.cached(timeout=info_randomizer_int_number['cache'])
...
@cache.cached(timeout=info_randomizer_float_number['cache'])
...
@cache.cached(timeout=info_parser_user_agent['cache'])
...
@cache.cached(timeout=info_requester_ip_address['cache'])
...
@cache.cached(timeout=info_scraper_media_youtube_com['cache'])
